        ...
        <div class="container-fluid">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href={{url("tenant/application/$client->client_id/application_document")}}>Documents</a></li>
                    <li><a href={{url("tenant/application/$client->client_id/application_notes")}}>Notes</a></li>
                </ul>
            </div>
            <!--/.nav-collapse -->
                            ...
                            <tr>
                                ...
                                <td>{{ ($client_note->remind == 1) ? 'yes' : 'no' }}</td>
                                 ...
                                 <td><a href="" target="_blank"><i class="fa fa-eye"></i> View</a>&nbsp;&nbsp;
                                    <a href="{{route('tenant.application.delete', $client_note->notes_id)}}" target="_blank" onClick="return confirm('Are you sure want to delete this record')" target="_blank"><i class="fa fa-trash"></i> Delete</a>
                                </td>
